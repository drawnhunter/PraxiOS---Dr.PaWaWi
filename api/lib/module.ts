...
export const MODUL_DEFS: ModulDef[] = [
  ...
  // ── Dr.PaWaWi-spezifisch ──
  {
    id: "anamnese",
    titel: "Anamnesebögen",
    beschreibung: "Bogen-Creator, mehrsprachige Links/QR, Übersetzung lokal",
    router: ["anamnese"],
  },
  {
    id: "austausch",
    titel: "Arzt-zu-Arzt-Austausch",
    beschreibung: "age-verschlüsselter Akten-Export/Import mit Einverständnis",
    router: ["austausch"],
  },
  {
    id: "rezepte",
    titel: "Rezepte & Atteste",
    beschreibung: "Privatrezepte, AUs, Atteste mit Unterschrifts-Stempel",
    router: ["rezepte"],
  },
  {
    id: "protokolle",
    titel: "Behandlungsprotokolle",
    beschreibung: "Block-Baukasten mit Verlaufs-Diagrammen und Vorlagen",
    router: ["protokolle"],
  },
];
