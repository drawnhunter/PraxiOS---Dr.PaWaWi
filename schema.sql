...
CREATE TABLE `company_settings` (
  ...
  `arzt_nr` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `documents` (
  ...
  `notiz` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dokumentdatum` date DEFAULT NULL,
  `quelle` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ocr_text` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ocr_status` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
