...
// Provider-Presets (1.15.0, Bus #60): Host/Port vorbefüllen, Hinweis geben.
        ...
        <DialogContent className="max-w-lg">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="col-span-2">
              ...
              {presetHinweis && (
                <p className="mt-1.5 rounded-md bg-amber-50 px-2.5 py-1.5 text-[11px] leading-snug text-amber-800">
                  {presetHinweis}
                </p>
              )}
            </div>
